...
RUN apt-get -y update && \
    apt-get -y install jq gcc make unzip gettext-base python2.7 python-dev python-setuptools python-software-properties curl ca-certificates software-properties-common apt-transport-https && \
